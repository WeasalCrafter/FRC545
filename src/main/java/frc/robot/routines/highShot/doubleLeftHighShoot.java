...
public class doubleLeftHighShoot extends SequentialCommandGroup{
    public doubleLeftHighShoot(Intake intake, Drivetrain drive, Shooter shooter, Support support, RobotContainer container){
        ...
        addCommands(
            ...
            new pickupThenShootSide(intake, drive, shooter, support, container, "left",ANGLE)
        );
    }
}
