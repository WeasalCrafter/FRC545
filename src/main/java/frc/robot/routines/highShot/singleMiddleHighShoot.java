...
public class singleMiddleHighShoot extends SequentialCommandGroup{
    public singleMiddleHighShoot(Intake intake, Drivetrain drive, Shooter shooter, Support support, RobotContainer container){
