...
public class MoveDiagonalForward extends SequentialCommandGroup {

    private double distanceX;
    private double distanceY;
    private double degrees;
	
	public MoveDiagonalForward(Drivetrain drivetrain, RobotContainer container, double distanceX, double distanceY, double degrees) {
