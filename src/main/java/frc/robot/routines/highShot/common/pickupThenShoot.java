...
public class pickupThenShoot extends SequentialCommandGroup{

    public pickupThenShoot(Intake intake, Drivetrain drive, Shooter shooter, Support support, RobotContainer container, String direction){
        ...
        addCommands(
            ...
            //new MoveForward(drive, container, DISTANCE_TO_NOTE_METERS), //Drive backward to note on floor
            new MoveDiagonalForward(drive, container, DISTANCE_TO_NOTE_METERS, (constant*DISTANCE_BETWEEN_NOTES_METERS),0), //Drive to right side note
            ...
            new MoveDiagonalBackward(drive, container, -DISTANCE_TO_NOTE_METERS, -(constant*DISTANCE_BETWEEN_NOTES_METERS),0), //Drive to goal
            ...
            //new MoveForward(drive, container, DISTANCE_TO_NOTE_METERS) //Drive backward to where note was
            //new MoveDiagonalForward(drive, container, DISTANCE_TO_NOTE_METERS, (constant * DISTANCE_BETWEEN_NOTES_METERS)) //Drive to right side note
        );
